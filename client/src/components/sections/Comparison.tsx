  ...
  return (
    <Section className="bg-navy-deep/50">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        <Reveal className="bg-white/5 border border-red-500/20 p-10 rounded-2xl relative overflow-hidden">
          <div className="text-red-400 font-bold text-sm uppercase tracking-wider mb-2">Typical Agencies</div>
          <h4 className="text-[22px] md:text-[24px] font-bold mb-6">Buy a list. Hit send. Hope.</h4>
        ...
        <Reveal delay={0.1} className="bg-navy-card border border-teal/30 p-10 rounded-2xl relative overflow-hidden shadow-[0_0_40px_rgba(0,201,219,0.05)]">
          <div className="text-teal font-bold text-sm uppercase tracking-wider mb-2">AutoUp</div>
          <h4 className="text-[22px] md:text-[24px] font-bold mb-6">Custom-built, AI-verified databases</h4>
          <ul className="space-y-5">
            {[
