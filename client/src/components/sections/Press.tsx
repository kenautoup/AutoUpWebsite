export function Press() {
  const logos = [
    ...
    { name: "TechCrunch", src: "/images/press/techcrunch.svg" },
    ...
    { name: "Inc5000", src: "/images/press/inc5000.svg" },
  ];
  ...
  return (
    <section className="py-16 border-y border-[#eef1f5] bg-[#f7f8fa] overflow-hidden">
      ...
      <div className="relative w-full">
        ...
        <div className="flex animate-scroll-left gap-16 md:gap-24 w-max py-4 items-center">
          {doubled.map((logo, i) => (
            <img
              key={`${logo.name}-${i}`}
              src={logo.src}
              ...
              className="h-8 md:h-10 w-auto object-contain opacity-30 hover:opacity-70 transition-opacity duration-300 flex-shrink-0"
