    ...
    <Section id="how-it-works" className="bg-white">
      <div className="text-center max-w-3xl mx-auto mb-10">
        <Reveal>
          ...
          <p className="text-[20px] text-[#64748b] leading-relaxed">
            Not opens. Not clicks. Positive replies from verified decision-makers — generated by an outbound engine built on custom data, golden copy, and proprietary infrastructure that hits the primary at scale.
          </p>
        </Reveal>
      </div>
      ...
      <Reveal delay={0.15}>
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div
            className="bg-[#f7f8fa] rounded-xl p-8 md:p-10"
