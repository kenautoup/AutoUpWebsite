      ...
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <Reveal delay={0.1}>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 leading-[1.1] font-sans text-gray-900">
            ...
            <em className="text-teal-600 italic">10x'd and Done For You</em>
          </h1>
        </Reveal>
        ...
        <Reveal delay={0.3}>
          <div className="flex flex-col items-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-3 bg-navy hover:bg-navy-deep text-white font-bold text-lg px-8 py-4 rounded-xl transition-all shadow-[0_4px_20px_rgba(11,26,46,0.3)] hover:shadow-[0_8px_30px_rgba(11,26,46,0.4)] hover:-translate-y-1"
            >
