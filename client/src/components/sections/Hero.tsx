      ...
      <div className="container mx-auto px-4 md:px-6 text-center">
        ...
        <Reveal delay={0.2}>
          <p className="text-[20px] md:text-[22px] text-[#64748b] max-w-[540px] mx-auto mb-8 leading-relaxed">
            Not opens. Not clicks. Real responses from verified decision-makers — delivered to the primary inbox at scale.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.4}>
          <dl className="mt-16 grid grid-cols-3 max-w-[720px] mx-auto border-t border-[#eef1f5] pt-10">
            {[
